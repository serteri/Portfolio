...
In the main section of the Home page. I divided this part into two parts. Left side has My name (Serter Iyigunlu to introduce) and a link to see my Portfolio. Rigth side has a form to join our newsletter.

Secon part of the main section blog examples have been added. You can see five different blogs with titles and images.

Last part is the footer. In this part you can acces my github,my linkedin and twitter.

On the About-me page, there is one main part which includes four different stages. First one is my experience ,second one my education. In the third section you can download my resume. There is a link to see my blog page at the last part of the section.

On the Portfolio page, you can see my jobs as a web developer. I added four jobs with pictures.

On the contact-me page, there is a form that you can fill out. You need to first name,last name ,email address and message. There is a radio button to as you whether you want to join our newsletter or not.

You can acces blog home page via About-me page by clicking click below to see my blog part.

On the blog page, there are total five blog entries, with blog titles and images. You can access each blog by clicking either images or titles. When you click one of them,you go to indiviual blog page.
...
```html
 <meta charset="UTF-8">
        ...
        <script src="https://kit.fontawesome.com/7d9ea28026.js" crossorigin="anonymous"></script>
        <title>Serter's Portfolio</title>
```
...
Nav bar section and footer section are the page as the home page.
...
Navbar and footer section are not written here because it is the same as home page.
            ...
            <section class="form-contact">
                <fieldset>
                    ...
                    <form id="form-contact">
                        <div class="form-elements">
                            <label for="firstName" class="select">First Name :</label>
                            <input
                                type="text"
                                name="firstName"
                                id="firstName"
                        ...
                        <div class="form-elements">
                            <label for="lastName" class="select">Last Name :</label>
                            <input
                                type="text"
                                name="lastName"
                                id="lastName"
                        ...
                        <div class="form-elements">
                            <label for="message" class="select">Message :</label>
                            <textarea
                                rows="2"
                                cols="2"
                                id="message"
                        ...
                        <div class="form-elements">
                            <button class="signing btn">Send</button>
                        </div>
                        <div class="form-elements signings">
                            <label for="newsletter" class="sign-label">Want to join our Newsletter</label>
                            <ul class="newsletter">
                                <li>
                                    <input
                                        type="radio"
...
$color-ahover: #e55b13;
$color-btn: #e55b13;
$color-backgroung: #2f3148;
$color-nav-logo-letter: #7a871e;
$color-left-side: #587099;
$color-right-side: #3f5576;
$color-text: #8689ac;
$color-footer: #3f5576;
```
...
@mixin flex-box-center-column-footer {
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
## About-me page css for mobile view and for tablet and desktop views
...
.general-info {
  ...
  height: 100vh;
  padding-left: 2rem;
  background-image: url(../images/webss.avif);
...
.general-info .experiences .experience {
  padding-bottom: 1.5rem;
  font-size: 1.5rem;
  text-align: center;
  font-family: "Montserrat", sans-serif;
...
## Contact-me page css for mobile view and for tablet and desktop views
...
.form-contact #form-contact .form-elements {
  margin-top: 0.6rem;
  width: 70%;
}
.form-contact #form-contact .form-elements .select {
  width: 80px;
  display: inline-block;
  color: #f6a21e;
  font-size: 0.6rem;
...
.form-contact #form-contact .form-elements .sign-label {
  width: 80px;
  display: inline-block;
  color: #587099;
  font-size: 0.6rem;
...
.form-contact #form-contact .form-elements .select-input {
  width: 50%;
}
.form-contact #form-contact .form-elements #message {
  width: 50%;
}
.form-contact #form-contact .form-elements .newsletter {
  list-style-type: none;
  font-family: "Montserrat", sans-serif;
  font-size: 0.6rem;
}
.form-contact #form-contact .form-elements .newsletter li {
  color: #7a871e;
  font-family: "Montserrat", sans-serif;
  font-weight: 700;
}
.form-contact #form-contact .form-elements .checkbox {
  width: 9px;
  height: 9px;
}

.wrapper .form-contact #form-contact .form-elements .signing {
  padding: 0.5rem;
  border-radius: 85px;
  background-color: #e1c340;
  color: #e55b13;
...
.wrapper .form-contact #form-contact .form-elements .signing:hover {
  transform: scale(1.2);
}
footer {
  background-color: #3f5576;
...
@media screen and (min-width: 600px) and (max-width: 759px) {
  ...
  .form-contact #form-contact .form-elements .signing {
    padding: 0.5rem;
    border-radius: 85px;
    background-color: #e1c340;
    color: #e55b13;
  ...
  .form-contact #form-contact .form-elements .signing :hover {
    transform: scale(1.2);
  }
  footer {
    background-color: #3f5576;
...
@media screen and (min-width: 960px) {
  ...
  .form-contact #form-contact .signings {
    margin-bottom: 2rem;
  }
  .form-contact #form-contact .form-elements .signing {
    padding: 0.5rem;
...
## Portfolio page css for mobile views and tablet and desktop views
...
## Css for other devies for home page
